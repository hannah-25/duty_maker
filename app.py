...
from core.models import build_month_requirements, compute_month_off_target
...
off_target_value = compute_month_off_target(int(year), int(month), holidays)
...
with info_col:
    st.caption(f"목표 오프일수: {off_target_value}일")
